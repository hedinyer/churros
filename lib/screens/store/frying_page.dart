...
class _FryingPageState extends State<FryingPage> {
  ...
  /// Muestra un modal grande para agregar un producto frito (fritar)
  Future<void> _mostrarModalAgregarFritado(Producto producto) async {
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            try {
                              ...
                              print('🔵 Guardando fritado: Producto ${producto.nombre}, Cantidad ingresada: $cantidadTexto, Valor parseado: $cantidad');
                              ...
                              // Si existe producto crudo, preparar descuento
                              if (productoCrudo != null) {
                              ...
                              try {
                                resultadoAtomico = await SupabaseService
                                    .guardarRecargaInventarioConDescuentoCrudos(
                                      ...
                                      observaciones: 'Fritado individual desde control de fritado',
                                    ).timeout(
                                      const Duration(seconds: 30),
                                      onTimeout: () {
                                        print('⏱️ Timeout al guardar fritado');
                                        return {
                                          'exito': false,
                                          'mensaje': 'Tiempo de espera agotado. El fritado puede haberse guardado. Verifica el inventario.',
                                        };
                                      },
                                    );
                              } catch (timeoutError) {
                              ...
                              if (exito) {
                                ...
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        '✓ Fritado guardado: $cantidad ${producto.unidadMedida} de ${producto.nombre}',
                                      ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: ElevatedButton(
                                                  onPressed: () {
                                                    // Abrir modal de fritado individual
                                                    _mostrarModalAgregarFritado(producto);
                                                  },
                                                  style: ElevatedButton.styleFrom(
                                                    backgroundColor:

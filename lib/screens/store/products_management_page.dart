...
class _ProductsManagementPageState extends State<ProductsManagementPage> {
              ...
              child:
                  _isLoading
                      ...
                      : RefreshIndicator(
                        onRefresh: _loadData,
                        child:
                            _getProductosFiltrados().isEmpty
                                ? Center(
                                  child: Text(
                                    'No hay productos',
                                    style: TextStyle(
  ...
  void _mostrarDialogoProducto({Producto? producto}) {
    ...
    final precioController = TextEditingController(
      text: producto?.precio.toStringAsFixed(0) ?? '0',
    );
    final unidadMedidaController = TextEditingController(
      text: producto?.unidadMedida ?? 'unidad',
    );
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<Categoria?>(
                        ...
                        items: [
                          ...
                          ..._categorias.map(
                            (cat) => DropdownMenuItem<Categoria?>(
                              value: cat,
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (producto == null) {
                        ...
                        final nuevoProducto =
                            await SupabaseService.crearProducto(
                              ...
                              precio: precio,
                              unidadMedida:
                                  unidadMedidaController.text.isEmpty
                                      ? 'unidad'
                        ...
                        final productoActualizado =
                            await SupabaseService.actualizarProducto(
